"""Typed view-model contracts for the Operational Intelligence Workstation (V3-P7).

Pure presentation data structures (stdlib only — NR-8). These mirror the clinical
workstation's view-models so the operational workstation presents a single, coherent
operational environment over every Version 3 subsystem.
...
from ..version import OPERATIONAL_VIEWMODEL_VERSION
...
class Section:
    ...
    title: str
    data: dict
    viewmodel_version: str = OPERATIONAL_VIEWMODEL_VERSION
