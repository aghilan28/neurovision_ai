...
No parallel audit system: the EEG foundation reuses the platform's single hash-chained
:class:`ImmutableAuditLog` (V2-P1), parameterised with :class:`EEGAuditRecord`. Every
ingestion, validation, storage, metadata-extraction, version change, and registration
